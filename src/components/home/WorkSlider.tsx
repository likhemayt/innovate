      ...
      <div ref={containerRef} className="flex gap-6 md:gap-12 px-6 md:px-24 w-max items-center">
        {items.map((item, i) => (
          ...
          >
            ...
            <div className={`relative z-10 h-full w-full p-8 md:p-16 lg:p-20 flex flex-col justify-end transition-all duration-700 delay-300 ${currentIndex === i ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="mt-auto">
                <span className="text-white/60 text-[10px] md:text-sm font-bold uppercase tracking-[0.4em] mb-4 block">{item.category}</span>
