...
const TestimonialSlider: React.FC<TestimonialSliderProps> = ({ items, title }) => {
  ...
  return (
    <section ref={sectionRef} className="py-40 px-6 md:px-24 bg-[#fafafa] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <h2 className="testimonial-title text-5xl md:text-8xl font-black tracking-tighter mb-24 uppercase text-center leading-none">{title}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {items.map((item, i) => (
            <div 
              ...
              className="group bg-white p-12 md:p-14 rounded-[3rem] border border-neutral-100 transition-all duration-700 hover:border-black hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] relative"
            >
              {/* Large quote icon */}
              <div className="absolute top-10 right-12 text-neutral-50 group-hover:text-black/5 transition-colors duration-700">
                <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 24 24" fill="currentColor" opacity="0.4"><path d="M14.017 21L14.017 18C14.017 16.8954 14.9124 16 16.017 16H19.017C19.5693 16 20.017 15.5523 20.017 15V9C20.017 8.44772 19.5693 8 19.017 8H16.017C15.4647 8 15.017 8.44772 15.017 9V12C15.017 12.5523 14.5693 13 14.017 13H11.017V21H14.017ZM5.017 21L5.017 18C5.017 16.8954 5.91243 16 7.017 16H10.017C10.5693 16 11.017 15.5523 11.017 15V9C11.017 8.44772 10.5693 8 10.017 8H7.017C6.46472 8 6.017 8.44772 6.017 9V12C6.017 12.5523 5.56929 13 5.017 13H2.017V21H5.017Z"/></svg>
              </div>

              <div className="relative z-10">
                <div className="mb-12 text-neutral-300 group-hover:text-black transition-colors duration-500">
                ...
                <p className="text-xl md:text-2xl font-medium leading-relaxed mb-12 text-neutral-600 tracking-tight">"{item.description}"</p>
                <div className="pt-8 border-t border-neutral-100 group-hover:border-neutral-200 transition-colors">
